...
public class test {
    ...
    public static void main(String[] args) {
        try {  
            ...
            QuartzManager.addJob(JOB_NAME, JOB_GROUP_NAME, TRIGGER_NAME, TRIGGER_GROUP_NAME, TimerAction.class, "0/1 * * * * ?");    
            QuartzManager.addJob("dddddd", JOB_GROUP_NAME, "wwwwww", TRIGGER_GROUP_NAME, DaysJob.class, "0/2 * * * * ?");
//            Thread.sleep(5000);    
